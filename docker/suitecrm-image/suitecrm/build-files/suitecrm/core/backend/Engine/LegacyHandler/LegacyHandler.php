...
abstract class LegacyHandler
{
    ...
    // FIX: followed the solution from this Github issue: https://github.com/salesagility/SuiteCRM-Core/issues/509
    // Need to removed this file when the fix is applied to the main branch and it's released
