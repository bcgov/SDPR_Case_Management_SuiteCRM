...
class CaseReminderAlerts extends FeedLogicBase
{
  public function createCaseReminderNotification($bean, $event, $arguments)
  {
    global $db;
    ...
    foreach($users as $user) {
      ...
      if ($total > 0) {
        ...
        $alert->url_redirect = 'index.php?module=Cases&action=reminder';
        $alert->save();
      }
    }
  }
