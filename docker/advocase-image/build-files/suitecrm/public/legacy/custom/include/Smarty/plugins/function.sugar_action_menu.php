...
function smarty_function_sugar_action_menu($params, &$smarty)
{
    ...
    // Return empty string if no buttons are provided
    if (empty($params['buttons'])) {
        return '';
    }

    // If buttons are provided and the flat menu is not enabled
    if (is_array($params['buttons']) && !$flat) {
        ...
        // Add all buttons to the items array
    ...
    // If buttons are provided and the flat menu is enabled
    if (is_array($params['buttons'])) {
        return '<div class="action_buttons">' . implode(' ', $params['buttons']) . '<div class="clear"></div></div>';
    } else if (is_array($params)) {

        return '<div class="action_buttons">' . implode(' ', $params) . '<div class="clear"></div></div>';
    }
