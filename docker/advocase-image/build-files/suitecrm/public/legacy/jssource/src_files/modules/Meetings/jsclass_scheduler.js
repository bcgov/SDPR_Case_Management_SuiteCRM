...
SugarWidgetSchedulerSearch.prototype.display = function () {
    ...
    create_invitees.setAttribute('style', 'display: none;');
    ...
    cell12.appendChild(create_invitees_buttons)
    ...
    label4.innerHTML = GLOBAL_REGISTRY['meeting_strings']['LBL_FIRST_NAME'] + ':';
    label4.style.display = 'block';
    cell31.appendChild(label4);
    ...
    label5.innerHTML = GLOBAL_REGISTRY['meeting_strings']['LBL_LAST_NAME'] + ':';
    label5.style.display = 'block';
    cell32.appendChild(label5);
    ...
    cell32.appendChild(input6);

    var cell33 = row3.insertCell(2);
    cell33.setAttribute('valign', 'top');
    ...
    this.parentNode.insertBefore(create_invitees, divWrapper.nextSibling)
...
SugarWidgetSchedulerSearch.showCreateForm = function (module) {
    ...
    document.getElementById('create-invitees').style.display = '';
    document.getElementById('list_div_win').style.display = 'none';
...
SugarWidgetSchedulerAttendees.prototype.display = function () {
    ...
    if (this.parentNode.childNodes.length < 1)
        ...
        this.parentNode.childNodes[4].innerHTML = html;
