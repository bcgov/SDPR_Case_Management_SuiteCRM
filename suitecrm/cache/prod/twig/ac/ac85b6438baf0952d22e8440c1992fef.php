...
class __TwigTemplate_246ffa43539631f4873dd315b62fe0da extends Template
{
    private $source;
    private $macros = [];
...
";
    ...
    {
        return new Source("", "@ApiPlatform/DataCollector/api-platform-icon.svg", "/suitecrm/vendor/api-platform/core/src/Symfony/Bundle/Resources/views/DataCollector/api-platform-icon.svg");
    }
}
