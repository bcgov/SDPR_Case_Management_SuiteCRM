...
class getSecurity_Listener_UserProviderService extends App_KernelProdContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 3).'/vendor/symfony/security-core/User/ChainUserProvider.php';
        ...
        return $container->privates['security.listener.user_provider'] = new \Symfony\Component\Security\Http\EventListener\UserProviderListener(new \Symfony\Component\Security\Core\User\ChainUserProvider(new RewindableGenerator(function () use ($container) {
            ...
            yield 1 => ($container->privates['security.user.provider.concrete.saml_provider'] ?? ($container->privates['security.user.provider.concrete.saml_provider'] = new \Hslavich\OneloginSamlBundle\Security\User\SamlUserProvider('App\\Module\\Users\\Entity\\User', [0 => 'ROLE_USER'])));
        }, 2)));
    }
}
