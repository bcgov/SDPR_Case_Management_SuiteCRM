...
class getSecurity_PasswordEncoderService extends App_KernelProdContainer
{
    ...
    {
        include_once \dirname(__DIR__, 3).'/vendor/symfony/security-core/Encoder/UserPasswordEncoderInterface.php';
        include_once \dirname(__DIR__, 3).'/vendor/symfony/security-core/Encoder/UserPasswordEncoder.php';
