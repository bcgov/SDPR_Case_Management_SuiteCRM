 ...
 */
class getSecurity_EventDispatcher_LoggedOutService extends App_KernelProdContainer
{
    /*
     * Gets the private 'security.event_dispatcher.logged_out' shared service.
     *
     * @return \Symfony\Component\EventDispatcher\EventDispatcher
     */
    public static function do($container, $lazyLoad = true)
    {
        $container->privates['security.event_dispatcher.logged_out'] = $instance = new \Symfony\Component\EventDispatcher\EventDispatcher();

        $instance->addListener('Symfony\\Component\\Security\\Http\\Event\\CheckPassportEvent', [0 => function () use ($container) {
            return ($container->privates['security.listener.logged_out.user_provider'] ?? $container->load('getSecurity_Listener_LoggedOut_UserProviderService'));
        ...
        $instance->addListener('Symfony\\Component\\Security\\Http\\Event\\LoginSuccessEvent', [0 => function () use ($container) {
            return ($container->privates['security.listener.session.logged_out'] ?? $container->load('getSecurity_Listener_Session_LoggedOutService'));
        }, 1 => 'onSuccessfulLogin'], 0);
        $instance->addListener('Symfony\\Component\\Security\\Http\\Event\\LogoutEvent', [0 => function () use ($container) {
            return ($container->privates['security.logout.listener.default.logged_out'] ?? $container->load('getSecurity_Logout_Listener_Default_LoggedOutService'));
        }, 1 => 'onLogout'], 64);
        $instance->addListener('Symfony\\Component\\Security\\Http\\Event\\LogoutEvent', [0 => function () use ($container) {
            return ($container->privates['security.logout.listener.session.logged_out'] ?? ($container->privates['security.logout.listener.session.logged_out'] = new \Symfony\Component\Security\Http\EventListener\SessionLogoutListener()));
        }, 1 => 'onLogout'], 0);
        $instance->addListener('Symfony\\Component\\Security\\Http\\Event\\CheckPassportEvent', [0 => function () use ($container) {
            return ($container->privates['security.listener.login_throttling.logged_out'] ?? $container->load('getSecurity_Listener_LoginThrottling_LoggedOutService'));
        }, 1 => 'checkPassport'], 2080);
        $instance->addListener('Symfony\\Component\\Security\\Http\\Event\\LoginSuccessEvent', [0 => function () use ($container) {
            return ($container->privates['security.listener.login_throttling.logged_out'] ?? $container->load('getSecurity_Listener_LoginThrottling_LoggedOutService'));
        }, 1 => 'onSuccessfulLogin'], 0);
        $instance->addListener('Symfony\\Component\\Security\\Http\\Event\\CheckPassportEvent', [0 => function () use ($container) {
            return ($container->privates['security.listener.user_checker.logged_out'] ?? $container->load('getSecurity_Listener_UserChecker_LoggedOutService'));
