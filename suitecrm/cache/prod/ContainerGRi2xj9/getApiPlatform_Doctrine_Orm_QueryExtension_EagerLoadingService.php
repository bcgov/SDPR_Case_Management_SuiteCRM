...
class getApiPlatform_Doctrine_Orm_QueryExtension_EagerLoadingService extends App_KernelProdContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 3).'/vendor/api-platform/core/src/Core/Bridge/Doctrine/Orm/Extension/ContextAwareQueryCollectionExtensionInterface.php';
        include_once \dirname(__DIR__, 3).'/vendor/api-platform/core/src/Core/Bridge/Doctrine/Orm/Extension/QueryItemExtensionInterface.php';
        include_once \dirname(__DIR__, 3).'/vendor/api-platform/core/src/Core/Bridge/Doctrine/Orm/Util/EagerLoadingTrait.php';
        include_once \dirname(__DIR__, 3).'/vendor/api-platform/core/src/Core/Bridge/Doctrine/Orm/Extension/EagerLoadingExtension.php';
